...
import_path = os.path.join(this_dir,"..","..","..")
...
class Environment(gym.Env):
  ...
  def movep(self, pose, speed=0.01):
    ...
    ret = self.movej(targj, speed)
    return ret


# TODO: [for your information]
# This function is where you are going to use your_ik function in ravens,
# Feel free to make changes if desired; otherwise, there's no need for modifications.
